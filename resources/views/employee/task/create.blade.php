            ...
            <form action="{{ url('admin/task') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control col-lg-6" name="user_id">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input name="subject" type="text" class="form-control col-lg-6 font-weight-bold">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <textarea name="description" rows="8" textarea class="form-control col-lg-6"></textarea>
                    </div>
                </div>
