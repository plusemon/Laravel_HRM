...
<p>
      ...
      <p>In many businesses, employees stand as the first line of interaction with the clients. These employees are totally held responsible for generating clients, keeping the present ones’ happy and retaining clients.
The Best Customer Centricity title identifies those employees who offer the best customer service.</p>
...
<center>
	<a href="admin-award-view-awards-profile"><button type="button" class="btn btn-success"><li class="far fa-eye">Generate PDF</li></button></a>
</center>
</div>
